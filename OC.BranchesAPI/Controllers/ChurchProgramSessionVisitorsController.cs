...
namespace OC.ChurchProgramSessionVisitorsAPI.Controllers
{
    ...
    public class ChurchProgramSessionVisitorsController : ControllerBase
    {
        ...
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(IEnumerable<ChurchProgramSessionVisitorViewModel>))]
        ...
        public IActionResult GetChurchProgramSessionVisitors()
        {
            ...
            return Ok(_mapper.Map<IEnumerable<ChurchProgramSessionVisitorViewModel >> (allChurchProgramSessionVisitors));
        }
        ...
        public IActionResult GetChurchProgramSessionVisitor([FromRoute] long id)
        {
            ...
            return Ok(_mapper.Map<ChurchProgramSessionVisitorViewModel>(churchProgramSessionVisitor));
        }

        // PUT: api/ChurchProgramSessionVisitor/5
        [HttpPut("{id}")]
        public async Task<IActionResult> PutChurchProgramSessionVisitor([FromRoute] long id, [FromBody] ChurchProgramSessionVisitorViewModel churchProgramSessionVisitor)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
            ...
            try
            {
                _unitOfWork.Entity.Update(_churchProgramSessionVisitor);
        ...
        public IActionResult UpdatedChurchProgramSessionVisitorIsActive(long id, [FromBody] ChurchProgramSessionVisitorViewModel churchProgramSessionVisitorViewModel)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> PostChurchProgramSessionVisitor([FromBody] ChurchProgramSessionVisitorViewModel churchProgramSessionVisitor)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
            ...
            var newChurchProgramSessionVisitor = _mapper.Map<ChurchProgramSessionVisitor>(churchProgramSessionVisitor);
