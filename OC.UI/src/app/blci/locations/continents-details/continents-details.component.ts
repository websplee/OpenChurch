...
@Component({
  selector: 'app-continents-details',
  templateUrl: './continents-details.component.html',
  styleUrls: ['./continents-details.component.scss']
})
export class ContinentsDetailsComponent implements OnInit {
